...
class ReportController extends Controller
{
    ...
    {
        $pledges = Pledge::select('pledges.*', 'type_gold.name as type_gold_name', 'product_details.id as product_detail_id', 'product_details.code', 'product_details.type_gold_id', 'product_details.size', 'product_details.gram', 'product_details.striped_id', 'product_details.details', 'product_details.allprice', 'customer.name as namecustomer', 'customer.lastname as lastnamecustomer', 'customer.tel as telcustomer', 'customer.address as addresscustomer','customer.idcard as idcardcustomer', 'pledges_line.id as pledges_line_id', 'pledges_line.status_check as pledges_line_status_check', 'history_pledges.customer_name as customername', 'history_pledges.due_date', 'history_pledges.deposit', 'history_pledges.created_at as created_history_pledges')->leftJoin('pledges_line', 'pledges_line.pledges_id', '=', 'pledges.id')->leftJoin('history_pledges', 'history_pledges.pledges_id', '=', 'pledges.id')->leftJoin('product_details', 'pledges_line.product_detail_id', '=', 'product_details.id')->leftJoin('customer', 'pledges.customer_id', '=', 'customer.id')->leftJoin('type_gold', 'product_details.type_gold_id', '=', 'type_gold.id')->where('pledges.id', $id)->orderBy('created_at', "desc")->groupBy('pledges_line.id')->get();
        $count = count($pledges);
        // dd($pledges);
        $customer = Customer::all();
        $productdetail = ProductDetails::all();
