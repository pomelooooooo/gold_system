...
@section('content')
            ...
            <div class="card">
                <div class="card-header"><div class="h4">ลงทะเบียน</div></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="idcard" class="col-md-4 col-form-label text-md-right">เลขบัตรประชาชน</label>
                        ...
                        <div class="form-group row">
                            <label for="telephone" class="col-md-4 col-form-label text-md-right">เบอร์โทร</label>
