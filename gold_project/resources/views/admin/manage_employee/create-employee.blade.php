...
<script>
    $(document).ready(function() {
        ...
        $(document).on('keyup', '#validationtel', function() {
            $.ajax({
                url: "/manage_employee/validateTel/" + $(this).val(),
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    if (data.status) {
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{route('manage_employee.store')}}" enctype="multipart/form-data" id="data" class="needs-validation" novalidate>
                ...
                <div class="row">
                    <div class="col-6">
                        <h4 for="validationusername">ชื่อผู้ใช้ <span style="color: red;"> *</span></h4>
                    </div>
                    <div class="col-3">
                        <h4 for="validationemail">อีเมล <span style="color: red;"> *</span></h4>
                    </div>
                    <div class="col-3">
                        <h4 for="validationpassword">พาสเวิร์ด <span style="color: red;"> *</span></h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <h4 for="idcard">เลขบัตรประชาชน <span style="color: red;"> *</span></h4>
                    </div>
                    <div class="col-6">
