...
@section('title','ผลการดำเนินงานการจำนำย้อนหลัง')
@section('content')
        ...
        $("body").on('click', '#print', function(e) {
            ...
            Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.open('/report_pledge/formpledge/' + id, '_blank')
                    }
                })
        })
    })
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 text-center">
                <div class="breadcrumb-text">
                    ...
                    <h1>ผลการดำเนินงานการจำนำย้อนหลัง</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <form class="form-inline" action="/report_pledge" method="GET">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-primary" id="print" data-id="{{$row['id']}}"><i class="fa fa-receipt"></i> ปริ้นใบรับซื้อฝากทอง</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
