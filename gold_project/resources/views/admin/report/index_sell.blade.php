        ...
        $("body").on('click', '#print', function(e) {
            ...
            Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.open('/report_sell/formsell/' + id, '_blank')
                    }
                })
        })
    })
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 text-center">
                <div class="breadcrumb-text">
                    ...
                    <h1>ผลการดำเนินงานการขายย้อนหลัง</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <form class="form-inline" action="/report_sell" method="GET">
                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-primary" id="print" data-id="{{$row['group_id']}}"><i class="fa fa-receipt"></i> ปริ้นใบกำกับภาษี</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div class="text-right">
                            <a type="button" class="btn btn-secondary" href="{{url('/sell_report')}}">กลับ</a>
                        </div>
                    </div>
                </div>
            </div>
